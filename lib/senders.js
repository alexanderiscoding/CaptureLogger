function sender(application, filename, line, network, host, version, uniqueId, brand, model, systemName, systemVersion, message, ID, token, senderHost, service, mode) {
  switch (service) {
    case "1":
      switch (mode) {
        case "1":
        ...
        case "2":
          ...
          structure12.push("[Acessar relatório do log](" + senderHost + "/api/view/" + ID + "/" + token + ")");
        ...
        case "3":
          ...
          structure13.push("<a href='" + senderHost + "/api/view/" + ID + "/" + token + "'>Acessar relatório do log</a>");
        ...
        case "2":
          ...
          return {
            ...
            content: {
              ...
              description: "",
              url: senderHost + "/api/view/" + ID + "/" + token,
              thumbnail: ""
            }
          }
        case "3":
      ...
      switch (mode) {
        ...
        case "2":
          ...
          return {
            ...
            buttonUrl: senderHost + "/api/view/" + ID + "/" + token
          }
        case "3":
          let structure33 = [];
          structure33.push({
          ...
          return {
            ...
            footer: "<" + senderHost + "/api/view/" + ID + "/" + token + "|Acessar relatório do log>"
          }
      }
      break;
    case "4":
