...
export default function handler(req, res) {
  ...
  return fetch(process.env.CLOUD_HOST + '/api/create', {
    method: 'POST',
    headers: {
    ...
    .then(async function (response) {
      ...
      if (process.env.SENDER_HOST != undefined) {
        let structure = sender(req.body.application, req.body.filename, req.body.line, req.body.network, req.body.host, req.body.version, req.body.uniqueId, req.body.brand, req.body.model, req.body.systemName, req.body.systemVersion, req.body.message, data, token, 'https://' + req.headers.host, process.env.SENDER_SERVICE, process.env.SENDER_MODE);
        let apiUrl;
